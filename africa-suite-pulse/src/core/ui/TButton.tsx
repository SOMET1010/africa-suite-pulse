...
const buttonVariants = cva(
  "inline-flex items-center justify-center select-none whitespace-nowrap tap-target px-4 py-2 rounded-xl text-sm font-medium shadow-soft transition-smooth focus-button disabled:opacity-50 disabled:pointer-events-none",
  {
    variants: {
      variant: {
        primary:
