...
import { Package, AlertTriangle, TrendingUp, ArrowLeft, BarChart3, Users } from "lucide-react";
...
import { AdvancedBusinessDashboard } from "@/features/pos/components/AdvancedBusinessDashboard";
import { CustomerLoyaltyPanel } from "@/features/pos/customer/components/CustomerLoyaltyPanel";
...
export default function POSInventoryPage() {
  ...
  return (
    <UnifiedLayout 
      title="Management POS Professionnel"
