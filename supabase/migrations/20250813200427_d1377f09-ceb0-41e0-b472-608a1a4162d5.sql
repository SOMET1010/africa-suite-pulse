-- Phase 2A: Corriger les vues SECURITY DEFINER (correction)
-- Corriger l'erreur de colonne dans la migration précédente

-- 1. Recréer guest_stay_history avec les bonnes colonnes
...
SELECT 
    ...
    r.date_arrival,
    r.date_departure,
    (r.date_departure - r.date_arrival) as nights_count, -- Calculer au lieu de référencer une colonne inexistante
    r.adults,
    r.children,
    r.rate_total,
...
-- 2. Recréer arrangements_with_calculated_price avec SECURITY INVOKER
