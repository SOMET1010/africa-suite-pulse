...
INSERT INTO public.pos_categories (org_id, outlet_id, name, sort_order, color, is_active) VALUES
(
...
DECLARE
    ...
    cat_entrees_id UUID;
BEGIN
    SELECT id INTO cat_boissons_id FROM public.pos_categories WHERE name = 'Boissons' AND org_id = '7e389008-3dd1-4f54-816d-4f1daff1f435';
    SELECT id INTO cat_plats_id FROM public.pos_categories WHERE name = 'Plats Principaux' AND org_id = '7e389008-3dd1-4f54-816d-4f1daff1f435';
    SELECT id INTO cat_desserts_id FROM public.pos_categories WHERE name = 'Desserts' AND org_id = '7e389008-3dd1-4f54-816d-4f1daff1f435';
    SELECT id INTO cat_entrees_id FROM public.pos_categories WHERE name = 'Entrées' AND org_id = '7e389008-3dd1-4f54-816d-4f1daff1f435';
