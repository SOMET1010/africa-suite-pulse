-- Drop and recreate functions to fix recursion issues
...
-- Create security definer function to safely access user data without RLS recursion
...
-- Recreate validate_pos_session with security definer
...
-- Recreate authenticate_pos_user with security definer
