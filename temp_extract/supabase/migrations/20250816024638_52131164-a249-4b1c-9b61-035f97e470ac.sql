...
CREATE TABLE public.fiscal_archive_entries (
  ...
  INDEX idx_fiscal_archive_entries_archive_id ON public.fiscal_archive_entries(archive_id),
  INDEX idx_fiscal_archive_entries_type ON public.fiscal_archive_entries(entry_type),
  INDEX idx_fiscal_archive_entries_timestamp ON public.fiscal_archive_entries(transaction_timestamp)
);
...
CREATE TABLE public.fiscal_compliance_logs (
  ...
  INDEX idx_fiscal_compliance_logs_org_id ON public.fiscal_compliance_logs(org_id),
  INDEX idx_fiscal_compliance_logs_event_type ON public.fiscal_compliance_logs(event_type)
);
