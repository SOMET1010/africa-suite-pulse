...
BEGIN
    ...
    (entrees_cat_id, restaurant_outlet_id, 'ENTR', 'Entrées', 'Entrées et amuse-bouches', '#10B981', 1, true),
    (plats_cat_id, restaurant_outlet_id, 'PLAT', 'Plats Principaux', 'Plats principaux du chef', '#3B82F6', 2, true),
    (gen_random_uuid(), restaurant_outlet_id, 'DESS', 'Desserts', 'Desserts maison', '#F59E0B', 3, true),
    (cocktails_cat_id, bar_outlet_id, 'COCK', 'Cocktails', 'Cocktails signature', '#8B5CF6', 1, true),
    (gen_random_uuid(), bar_outlet_id, 'WINE', 'Vins', 'Sélection de vins', '#DC2626', 2, true),
    (gen_random_uuid(), spa_outlet_id, 'MASS', 'Massages', 'Soins et massages', '#06B6D4', 1, true);
