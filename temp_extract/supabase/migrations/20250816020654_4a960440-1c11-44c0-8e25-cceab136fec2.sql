...
-- Insert some default kitchen messages
INSERT INTO public.pos_kitchen_messages (org_id, category, message_text, icon, color, display_order) VALUES
(get_current_user_org_id(), 'cooking', 'Bien cuit', '🔥', '#ef4444', 1),
(get_current_user_org_id(), 'cooking', 'Saignant', '🥩', '#dc2626', 2),
(get_current_user_org_id(), 'cooking', 'À point', '👌', '#f59e0b', 3),
(get_current_user_org_id(), 'allergy', 'Sans gluten', '🌾', '#eab308', 1),
(get_current_user_org_id(), 'allergy', 'Sans lactose', '🥛', '#06b6d4', 2),
(get_current_user_org_id(), 'allergy', 'Végétarien', '🌱', '#10b981', 3),
(get_current_user_org_id(), 'allergy', 'Végan', '🌿', '#059669', 4),
(get_current_user_org_id(), 'special', 'Extra épicé', '🌶️', '#dc2626', 1),
(get_current_user_org_id(), 'special', 'Peu salé', '🧂', '#6b7280', 2),
(get_current_user_org_id(), 'special', 'Sur le côté', '↔️', '#8b5cf6', 3),
(get_current_user_org_id(), 'timing', 'Priorité', '⚡', '#f59e0b', 1),
(get_current_user_org_id(), 'timing', 'Pas pressé', '⏱️', '#10b981', 2);
