-- CORRECTIONS FINALES DE SÉCURITÉ - Phase 4 (Version finale)
...
-- 2. Suppression de toutes les politiques problématiques sur rate_limits (si elles existent)
...
DROP POLICY IF EXISTS "Users can manage rate limits for their org" ON rate_limits;
