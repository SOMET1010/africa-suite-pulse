-- Add org_id column to pos_products
...
BEGIN
    ...
    INSERT INTO public.pos_products (id, org_id, outlet_id, category_id, code, name, description, base_price, is_active, image_url, preparation_time) VALUES
    (gen_random_uuid(), existing_org_id, restaurant_outlet_id, entrees_cat_id, 'ENT001', 'Foie gras poêlé', 'Foie gras poêlé aux figues confites', 28.50, true, null, 15),
    (gen_random_uuid(), existing_org_id, restaurant_outlet_id, entrees_cat_id, 'ENT002', 'Carpaccio de bœuf', 'Carpaccio de bœuf aux copeaux de parmesan', 22.00, true, null, 10),
    (gen_random_uuid(), existing_org_id, restaurant_outlet_id, plats_cat_id, 'PLAT001', 'Filet de bœuf', 'Filet de bœuf grillé sauce béarnaise', 45.00, true, null, 25),
    (gen_random_uuid(), existing_org_id, restaurant_outlet_id, plats_cat_id, 'PLAT002', 'Poisson du jour', 'Poisson frais du marché aux légumes de saison', 38.00, true, null, 20);

    -- Insert test products for bar
    INSERT INTO public.pos_products (id, org_id, outlet_id, category_id, code, name, description, base_price, is_active, image_url, preparation_time) VALUES
    (gen_random_uuid(), existing_org_id, bar_outlet_id, cocktails_cat_id, 'COCK001', 'Mojito Royal', 'Mojito classique avec rhum premium', 15.00, true, null, 5),
    (gen_random_uuid(), existing_org_id, bar_outlet_id, cocktails_cat_id, 'COCK002', 'Cosmopolitan', 'Cocktail signature de la maison', 18.00, true, null, 5);
