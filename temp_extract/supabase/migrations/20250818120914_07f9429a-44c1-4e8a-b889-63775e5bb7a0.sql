-- Supprimer la fonction existante et implémenter la solution corrigée

-- 1. Supprimer l'ancienne fonction qui cause le conflit
DROP FUNCTION IF EXISTS public.generate_pos_session_number();
